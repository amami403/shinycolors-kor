...
프로듀스 커뮤와 이벤트 커뮤, 그리고 아이돌 커뮤까지 게임내 대부분의 텍스트를 구글 번역으로 번역해줍니다.
...
각 대사 항목의 번역 본을 text-user 항목에 넣어주세요. 이미 DB에 들어가 text-patch가 존재하는 항목은 오역이 아닌 이상 text-user를 이용해 덮어쓰는 일이 없도록 해주세요.
전송시에는 기여 목록에 기재하고 싶은 닉네임 또는 이름을 포함해주시길 바랍니다. 익명으로 보내실땐 따로 기재해주시면 됩니다.
